          ...
          >
            ...
            <div className="min-w-[30vw] shadow-2xl rounded-lg p-4 flex flex-col gap-4 overflow-hidden border-[1px]  bg-white min-h-[30vh]">
              ...
              <div className="flex flex-col gap-2 w-full p-2 items-center justify-center">
                <input className="w-full p-2 border-[1px] rounded-lg"></input>
                ...
                <div className="flex justify-between w-full mt-4">
                  ...
                  <div className="border-[1px] bg-blue-400 p-2 rounded-3xl pl-4 pr-4 text-white flex items-center justify-center hover:shadow-2xl duration-150 transition-all ease-in-out">
                    Done
                  </div>
                </div>
              </div>
